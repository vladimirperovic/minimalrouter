...
function StaticDNSRecordsEditor({ records, disabled }: { records: DNSRecordRow[]; disabled: boolean }) {
  ...
  return (
    <fieldset className="dns-records-fieldset">
      <div className="fieldset-title">Static DNS records</div>
