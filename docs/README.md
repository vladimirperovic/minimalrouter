...
lint/unit/build/E2E, clean Alpine installation and rollback, crash recovery,
fuzzing, security analysis, ARM64 QEMU smoke tests, network namespace validation,
