# Proxmox VE — v0.1.5 Golden ISO pilot

Minimal Router OS should run as a QEMU/KVM VM, not an LXC container.

v0.1.5's preferred first-install path is the Golden Appliance ISO. You do not
...
- CD/DVD: MinimalRouter v0.1.5 ISO
...
2. Attach the verified `minimalrouter-0.1.5-amd64.iso`.
...
Minimal Router v0.1.5 remains a controlled Beta pilot, not an unattended
