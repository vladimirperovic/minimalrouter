...
check "peer active in wg0 runtime" retry 60 mr "wg show wg0 | grep -q 'lab-rot-peer'"
...
check "peer gone from wg0 runtime" retry 60 check_not mr "wg show wg0 | grep -q 'lab-rot-peer'"
