...
phase "5-lan-client"
check "client renews lease after router reboot" lan "sudo dhclient -r eth0 2>/dev/null; sleep 1; sudo dhclient eth0 2>/dev/null; sleep 8; ip -4 -o addr show | grep -q '192.168.1.'"
