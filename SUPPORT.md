...
v0.1.7. There is no commercial support, guaranteed response time, production SLA
or warranty.

v0.1.7 is intended for controlled pilots with console access and a known-good
...
4. Confirm the exact release or commit. Prefer the published v0.1.7 release over
...
For v0.1.7 Golden ISO problems, include:
